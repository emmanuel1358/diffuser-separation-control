#!/usr/bin/env python3
"""Deterministically regenerate the tabular example's public/private data."""
...
def generate(output_root: Path) -> None:
    ...
    _write(output_root / "data" / "public" / "train.parquet", train)
    _write(output_root / "data" / "public" / "test.parquet", test_features)
    _write(
        output_root / "data" / "private" / "test_target.parquet",
        test_targets,
    )
